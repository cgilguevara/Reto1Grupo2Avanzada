        ...
        .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
          ...
          public void onComplete(@NonNull Task<AuthResult> task) {
            if (task.isSuccessful()) {
              // Producto registrado con éxito en Firebase Authentication
              Log.d("Firebase Authentication", "Producto registrado con éxito");
                ...
                db.collection("usuarios")
                    ...
                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                      ...
                      public void onSuccess(Void Void) {
                        // Producto registrado exitosamente en Firestore
                        Log.d("Firestore", "Producto registrado exitosamente en Firestore");
                        Toast.makeText(RegisterActivity.this, "Producto registrado exitosamente", Toast.LENGTH_SHORT).show();
                      }
                    });

                // Limpiar los campos después del registro exitoso para un nuevo registro futuro
